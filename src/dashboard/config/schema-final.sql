-- Final Supabase Database Schema for CMS Cloud Storage
-- This version avoids all potential compatibility issues
...
-- Insert initial configuration (simple version)
INSERT INTO cms_config (key, value) VALUES 
('system_initialized', '{"initialized": true, "version": "1.0.0"}'::jsonb);
