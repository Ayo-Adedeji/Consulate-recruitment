...
const HeroCards = () => {
  ...
  return (
    ...
    >
      {/* Background blobs - positioned to not cause overflow */}
      <div className="absolute top-0 left-0 w-72 h-72 bg-blue-200 opacity-20 rounded-full blur-3xl animate-pulse z-0 -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-72 h-72 bg-purple-200 opacity-20 rounded-full blur-3xl animate-pulse z-0 translate-x-1/2 translate-y-1/2"></div>
